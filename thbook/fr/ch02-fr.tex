...
Nous n'avons \'ecrit ce travail que pour vous, enfants de doctrine et d'apprentissage. 
Examinez ce livre, r\'efl\'echissez au sens que nous avons dispers\'e et rassembl\'e \`a nouveau ; 
...
* {\it ext\_keyword/mot-clef\_\'etendu} = mot-cl\'e pouvant \'egalement contenir des caract\`eres  |+*.,'|, 
...
* |OSGB:<H, N, O, S or T><a-Z except I>| =Grille nationale du British Ordnance Survey.\NEW{5.4}
...
\comopt
  ...
  * |station <station> <commentaire> [<flags>]| = ajouter le commentaire de la station et ses marqueurs. 
                                                                             Si |""| est indiqu\'e comme commentaire, il est ignor\'e.
                                                                              ...
                                                                              |entrance| (entr\'ee), |continuation|, |air-draught[:winter/summer]| (courant d'air [:hiver / \'et\'e], 
...
\options
  * |projection <specification>| = sp\'ecifie la projection du dessin. Chaque projection est identifi\'ee par un type 
    ...
    3. |elevation| = Projection orthogonale (pour une coupe projet\'ee), 
                            qui prend \'eventuellement la direction de la vue comme argument (par exemple |[elevation 10]| ou |[elevation 10 deg]|).
  ...
  * |scale <specification>| = Est utilis\'e pour une pr\'e-mise \`a l'\'echelle (conversion des coordonn\'ees de pixels en m\`etres) des donn\'ees du scrap. 
    ...
    2. |[<nomber> <unites de longueur>]| = |<nombre> <unites de longueur>| par unit\'e de dessin.
...
\arguments
  ...
  * |<type>| determine le type d'objet. Les termes suivants sont accept\'es :
    ...
    |station-name|\[Si aucun texte n'est sp\'ecifi\'e, le nom de la station la plus proche est utilis\'e.], \penalty-100
...
\options
  ...
  * |context <point/line/area> <symbol-type>| = (doit \^etre utilis\'e avec les options |symbol-hide| et |symbol-show| de la mise en page (layout)) 
                                                                           ...
                                                                           la commande |symbol-hide point air-draught| masquera \`a la fois la fl\`eche du courant d'air et l'\'etiquette correspondante.]
...
\arguments
   * |<type>| est un mot-cl\'e qui d\'etermine le type de ligne. Les types suivants sont accept\'es :
     ...
     |water-flow| ;
     (plancher stalagmitique, lait de lune, bordure rocheuse, ar\^ete rocheuse, \'ecoulement d'eau) ;
...
\description
  ...
  in one join statement. \[Comme par exemple 
...
\description
   ...
   Les grades ou degr\'es int\'egr\'es sont : BCRA\[voir \www{http://bcra.org.uk/surveying/} ;
     ...
     Degr\'e |X| $\gg$ Topographie bas\'ee principalement sur l'utilisation d'un th\'eodolite / station totale (tach\'eom\`etre).] 
...
\list
* lors de l'exportation de {\it shapefiles} (fichiers de donn\'ees vectorielles pour syst\`eme d'information g\'eographique---SIG), elles sont \'ecrites directement dans le fichier dbf associ\'e. 
* dans les topographies (`maps') g\'en\'er\'ees \`a l'aide de \MP (PDF, SVG), les attributs sont \'ecrits dans le fichier source \MP 
  ...
  Vous pouvez tester la pr\'esence d'une telle variable en utilisant i|if known aTTR_<name>: ... fi|.
\endlist
...
\list
* {\it symboles points :} symboles de remplissages de galeries/passages (substrat rocheux\dots guano),
